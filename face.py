...
sidharth_image = face_recognition.load_image_file("sidharth.jpg")
sidharth_encoding = face_recognition.face_encodings(sidharth_image)[0]

utkarsh_image = face_recognition.load_image_file("utkarsh.jpg")
